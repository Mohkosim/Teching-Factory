...
export default function RingkasanRatingJasa({
  rating,
  jumlahReview,
  persentasePuas,
  breakdown,
  ...
  return (
    <Card className="rounded-2xl border-gray-100">
      <CardContent className="grid grid-cols-1 gap-6 px-6 sm:grid-cols-[auto_1fr]">
        <div>
          ...
          <p className="mt-2 text-sm font-semibold text-gray-700">
            {persentasePuas}% pelanggan merasa puas
          </p>
          <p className="text-xs text-gray-400">
            {jumlahReview.toLocaleString("id-ID")} rating • {jumlahReview.toLocaleString("id-ID")} review
          </p>
        </div>
