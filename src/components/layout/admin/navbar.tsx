...
import { getProfilePath } from "@/lib/config/side-config";
                    ...
                    <DropdownMenuLabel className="font-normal">
                        <div className="flex items-center gap-3 py-1">
                            <Avatar className="h-9 w-9 shrink-0 overflow-hidden rounded-full">
                                ...
                                <AvatarFallback className="bg-primary/20 text-primary text-sm font-semibold flex items-center justify-center">
